...
const validSchema = object({
  idCard: number()
    ...
    .test(
      "len",
      "Id Number Must be 4 Characters ",
  ...
  return (
    <>
      ...
      <Formik
        ...
        onSubmit={(values) =>
          logIn(`${values.idCard}${values.idYear}`, values.password)
        }
        ...
        {({
          ...
          <View style={styles.container}>
            ...
            {(touched.idCard || touched.idYear) && (
              <ErrorText
                error={errors.idCard ? errors.idCard : errors.idYear}
              />
            )}
