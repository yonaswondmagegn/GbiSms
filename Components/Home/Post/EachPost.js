  ...
  return (
    ...
    >
      <View
        style={[
          styles.container,
          { backgroundColor: darkMode ? color.darkBackground : "#fff" },
        ]}
      >
        <View style={styles.postContainerHeader}>
          <Text
            numberOfLines={3}
            style={[styles.titleText, { color: darkMode ? "white" : "black" }]}
          >
            {post.title}
          </Text>
          <Text
        ...
        <Text
          numberOfLines={3}
          style={[styles.postExerpt, { color: darkMode ? "#ccc" : "#333" }]}
        >
          {post.fragments[0].content}
        </Text>
