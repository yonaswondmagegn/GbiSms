  ...
  return (
    <View style={[styles.container]}>
        <TouchableOpacity onPress={beforeHandler}>
            <MaterialIcons name='navigate-before'size={50} color={darkMode?'white':'black'} />
        </TouchableOpacity>
        <View style={{alignSelf:'center'}}>
            <Text style={{color:darkMode?'white':'black'}} >{ethiopianMonths[month]} {year}</Text>
        </View>
        <TouchableOpacity onPress={nextHandler}>
            <MaterialIcons name='navigate-next' size={50} color={darkMode?'white':'black'} />
